...
var AddComponent = /** @class */ (function () {
    ...
    AddComponent.prototype.ngOnInit = function () {
        ...
        if (this.mode == 1) {
            ...
            this.NameTask.text = this.item[taskModel_tns_1.TaskModel.FieldNames.name];
            this.Desc.text = this.item[taskModel_tns_1.TaskModel.FieldNames.desc];
        }
        else {
            this.newObject = taskModel_tns_1.TaskModel.getEmptyObject();
        }
    };
    AddComponent.prototype.addTask = function (event) {
        if (this.NameTask.text && this.mode == 0) {
            this.newObject[taskModel_tns_1.TaskModel.FieldNames.name] = this.NameTask.text;
            this.newObject[taskModel_tns_1.TaskModel.FieldNames.desc] = this.Desc.text;
    ...
    AddComponent.prototype.showReminder = function (event) {
        ...
        this.modalService.showModal(reminder_component_1.ReminderComponent, options)
            ...
            if (dialogResult) {
                dialogResult.context.newObject[taskModel_tns_1.TaskModel.FieldNames.reminder] = dialogResult.data[taskModel_tns_1.TaskModel.FieldNames.reminder];
                dialogResult.context.newObject[taskModel_tns_1.TaskModel.FieldNames.time] = dialogResult.data[taskModel_tns_1.TaskModel.FieldNames.time];
                dialogResult.context.newObject[taskModel_tns_1.TaskModel.FieldNames.date] = dialogResult.data[taskModel_tns_1.TaskModel.FieldNames.date];
                dialogResult.context.newObject[taskModel_tns_1.TaskModel.FieldNames.repeat] = dialogResult.data[taskModel_tns_1.TaskModel.FieldNames.repeat];
            }
        });
    };
    AddComponent.prototype.showPriority = function (event) {
        ...
        this.modalService.showModal(priority_component_1.PriorityComponent, options)
            .then(function (dialogResult) {
            if (dialogResult) {
                dialogResult.context.newObject[taskModel_tns_1.TaskModel.FieldNames.priority] = dialogResult.data;
            }
        });
    };
    __decorate([
