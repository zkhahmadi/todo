...
var ReminderComponent = /** @class */ (function () {
    function ReminderComponent(modalService, modalDialogParams) {
        ...
        this.setd = function (selectedDate) {
            if (selectedDate) {
                ...
                this.result[taskModel_1.TaskModel.FieldNames.date] = selectedDate.toLocaleDateString(undefined, options); //.split(" ").join("-");      
            }
        };
        this.sett = function (selectedDate) {
            if (selectedDate) {
                ...
                this.result[taskModel_1.TaskModel.FieldNames.time] = l.slice(17, 24);
            }
        };
    }
    ReminderComponent.prototype.save = function (event) {
        var _a;
        if (this.result[taskModel_1.TaskModel.FieldNames.date]) {
            this.modalDialogParams.closeCallback({ context: this.modalDialogParams.context, data: this.result });
        }
        else {
            this.modalDialogParams.closeCallback({ context: this.modalDialogParams.context, data: (_a = {}, _a[taskModel_1.TaskModel.FieldNames.time] = null, _a[taskModel_1.TaskModel.FieldNames.date] = null, _a[taskModel_1.TaskModel.FieldNames.reminder] = null, _a[taskModel_1.TaskModel.FieldNames.repeat] = null, _a) });
        }
    };
    ReminderComponent.prototype.ngOnInit = function () {
        ...
        if (this.mode == 1) {
            ...
            if (this.result[taskModel_1.TaskModel.FieldNames.date] && this.result[taskModel_1.TaskModel.FieldNames.date] != "null" &&
                this.result[taskModel_1.TaskModel.FieldNames.date] != "undefined" && this.result[taskModel_1.TaskModel.FieldNames.date] != "") {
                this.lblDate.text = this.result[taskModel_1.TaskModel.FieldNames.date];
            }
            if (this.result[taskModel_1.TaskModel.FieldNames.time] && this.result[taskModel_1.TaskModel.FieldNames.time] != "null" &&
                this.result[taskModel_1.TaskModel.FieldNames.time] != "undefined" && this.result[taskModel_1.TaskModel.FieldNames.time] != "") {
                this.lblTime.text = this.result[taskModel_1.TaskModel.FieldNames.time];
            }
        }
        else {
            this.result = (_a = {}, _a[taskModel_1.TaskModel.FieldNames.time] = null, _a[taskModel_1.TaskModel.FieldNames.date] = null, _a[taskModel_1.TaskModel.FieldNames.reminder] = null, _a[taskModel_1.TaskModel.FieldNames.repeat] = null, _a);
        }
    ...
    ReminderComponent.prototype.setDate = function (event) {
        ...
        if (this.mode == 1) {
            ...
            if (this.result[taskModel_1.TaskModel.FieldNames.date] && this.result[taskModel_1.TaskModel.FieldNames.date] != "null" &&
                this.result[taskModel_1.TaskModel.FieldNames.date] != "undefined" && this.result[taskModel_1.TaskModel.FieldNames.date] != "") {
                var d = Date.parse(this.result[taskModel_1.TaskModel.FieldNames.date] + " 00:00:00 GMT");
                dd.setTime(d);
            }
            option = {
    ...
    ReminderComponent.prototype.setTime = function (event) {
        ...
        if (this.mode == 1) {
            ...
            if (this.result[taskModel_1.TaskModel.FieldNames.time] && this.result[taskModel_1.TaskModel.FieldNames.time] != "null" &&
                this.result[taskModel_1.TaskModel.FieldNames.time] != "undefined" && this.result[taskModel_1.TaskModel.FieldNames.time] != "") {
                var s = this.result[taskModel_1.TaskModel.FieldNames.time].split(":");
                if (s.length >= 2) {
    ...
    ReminderComponent.prototype.removeTime = function (event) {
        ...
        this.result[taskModel_1.TaskModel.FieldNames.time] = null;
    };
